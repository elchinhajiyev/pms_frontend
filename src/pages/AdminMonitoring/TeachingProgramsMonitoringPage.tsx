...
export default function TeachingProgramsMonitoringPage() {
  const { user } = useAuth();
  ...
  const openDetailsModal = (item: TeachingProgramItem) => {
  ...
  return (
    <>
      <PageMeta title="Tədris metodiki vəsaitlər monitorinq | Performix" description="Tədris proqramlarının monitorinqi və təsdiqi" />
      <PageBreadcrumb pageTitle="Tədris metodiki vəsaitlər monitorinq" />

      <div className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Tədris proqramları monitorinq</h3>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 text-left text-gray-600 dark:border-gray-700 dark:text-gray-400">
                  <th className="pb-3 pr-4 font-medium">Proqramın adı</th>
        ...
        {selectedItem && (
          <div className="rounded-3xl bg-white p-5 dark:bg-gray-900 sm:p-6">
            <h3 className="mb-4 pr-12 text-lg font-semibold text-gray-800 dark:text-white">
              Tədris proqramı detalları
            </h3>

            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Proqramın adı</p>
