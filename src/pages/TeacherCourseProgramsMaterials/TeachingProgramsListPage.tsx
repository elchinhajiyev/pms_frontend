...
export default function TeachingProgramsListPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setError(err?.response?.data?.message || "Tədris proqramları yüklənmədi");
      setItems([]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <>
      <PageMeta title="Tədris proqramları | Performix" description="Müəllim üçün tədris proqramları siyahısı" />
      <PageBreadcrumb pageTitle="Tədris proqramları" />

      <div className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Tədris proqramlarım</h3>
          <button
            onClick={() => navigate("/usercourseprograms/new")}
        ...
        {loading ? (
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Hələ tədris proqramı əlavə edilməyib.</p>
        ) : (
                    ...
                    <td className="py-3 pr-4 text-right">
                      <div className="inline-flex items-center gap-2">
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/usercourseprograms/${item.id}/edit`)}
                          ...
                          aria-label="Proqramı redaktə et"
      ...
      <Modal isOpen={Boolean(selectedItem)} onClose={() => setSelectedItem(null)} className="m-4 w-full max-w-3xl">
        {selectedItem && (
          <div className="rounded-3xl bg-white p-5 dark:bg-gray-900 sm:p-6">
            <h3 className="mb-4 pr-12 text-lg font-semibold text-gray-800 dark:text-white">Tədris proqramı detalları</h3>
